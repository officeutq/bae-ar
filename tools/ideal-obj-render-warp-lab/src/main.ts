...
type PlacementFunctionRepeatSummary = {
  repeatCount: number
  uniqueConditionCount: number
  sampleCount: number
  usableSampleCount: number
  negTzWithinCondition: {
    meanRange: number
    maxRange: number
    meanStdDev: number
    maxStdDev: number
  }
  invNegTzWithinCondition: {
    meanRange: number
    maxRange: number
    meanStdDev: number
    maxStdDev: number
  }
  scaleRatioWithinCondition: {
    meanEstimatedRange?: number
    maxEstimatedRange?: number
  }
}

type PlacementFunctionPositionCorrelationSummary = {
  scaleRatio: number
  usableSampleCount: number
  corrCenterImageXNegTz: number | null
  corrCenterImageYNegTz: number | null
  corrCenterImageXInvNegTz: number | null
  corrCenterImageYInvNegTz: number | null
  negTzMin: number
  negTzMax: number
  negTzRange: number
  negTzMean: number
...
type PlacementFunctionVerticalPositionSummary = {
  scaleRatio: number
  centerImageY: number
  usableSampleCount: number
  negTzMin: number
...
type PlacementFunctionAnalysisExport = {
  ...
  summary: {
    ...
    roundtripComparisonSummary?: PlacementFunctionRoundtripComparisonSummary
    conditionBatchRoundtripComparisonSummary?: PlacementFunctionConditionBatchRoundtripComparisonSummary
  }
...
type PlacementFunctionCandidate = {
  ...
  source: {
    ...
    usableSampleCount: number
    uniqueConditionCount: number
    fittingSampleCount: number
    fittingAggregation: "condition_mean" | "raw_samples"
  }
...
type PlacementFunctionRoundtripLandmarkDiffSummary = {
  ...
  comparedTo?: "selected_sample_target478" | "representative_sample_target478"
}

type PlacementFunctionRoundtripMediaPipeResult = {
  detected: boolean
  returnedLandmarkCount: number
  returnedPose: {
    yaw: number
...
type PlacementFunctionRoundtripExecutionResult = {
  predictedMediaPipeResult: PlacementFunctionRoundtripMediaPipeResult
  predictedMatrixFeatures: PlacementFunctionRoundtripMatrixFeatures | null
  matrixError: PlacementFunctionRoundtripMatrixError | null
  poseError: PlacementFunctionRoundtripPoseError | null
  landmarkDiffSummary: PlacementFunctionRoundtripLandmarkDiffSummary | null
...
type PlacementFunctionRoundtripComparisonScores = {
...
type PlacementFunctionRoundtripComparisonResult = {
  ...
  poseError: PlacementFunctionRoundtripPoseError | null
  landmarkDiffSummary: PlacementFunctionRoundtripLandmarkDiffSummary | null
  scores: PlacementFunctionRoundtripComparisonScores
}

type PlacementFunctionRoundtripComparisonState = {
  status: "idle" | "running" | "completed" | "error"
  sampleIndex: number | null
  candidateIds: PlacementFunctionRoundtripCandidateId[]
  results: PlacementFunctionRoundtripComparisonResult[]
  bestByRoundtripScoreCandidateId: PlacementFunctionRoundtripCandidateId | null
  bestByMatrixNormalizedScoreCandidateId: PlacementFunctionRoundtripCandidateId | null
  previewPredictedCandidateId: PlacementFunctionRoundtripCandidateId | null
  previewPredictedLandmarks478: ReferenceLandmark[] | null
  errorMessage?: string | null
}

type PlacementFunctionRoundtripComparisonSummary = Omit<
  PlacementFunctionRoundtripComparisonState,
  "previewPredictedLandmarks478" | "previewPredictedCandidateId"
>

type PlacementFunctionRoundtripInput = PlacementFunctionCandidateTrainingSample & {
  requestedPoseP: ObjPoseMappingPose
  mediaPipeResult: {
    returnedPose?: {
      yaw: number
...
type PlacementFunctionConditionRoundtripInput = PlacementFunctionRoundtripInput & {
  representativeSampleIndex: number | null
  repeatSampleCount: number
  usableSampleCount: number
}

type PlacementFunctionConditionBatchStatus = "idle" | "running" | "completed" | "cancelled" | "error"

type PlacementFunctionConditionBatchFullScoreStats = {
  mean: number | null
  p50: number | null
  p90: number | null
  p95: number | null
...
type PlacementFunctionConditionBatchCompactScoreStats = {
  mean: number | null
  p95: number | null
  max: number | null
}
...
type PlacementFunctionConditionBatchCandidateSummary = {
  ...
  detectedCount: number
  noFaceCount: number
  matrixNormalizedScore: PlacementFunctionConditionBatchFullScoreStats
  roundtripScore: PlacementFunctionConditionBatchFullScoreStats
  matrixRawTranslationScore: PlacementFunctionConditionBatchCompactScoreStats
  poseScore: PlacementFunctionConditionBatchCompactScoreStats
  landmarkScore: PlacementFunctionConditionBatchCompactScoreStats
  winCounts: {
    byRoundtripScore: number
    byMatrixNormalizedScore: number
  }
}

type PlacementFunctionConditionBatchResult = {
  conditionKey: string
  representativeSampleIndex: number | null
  repeatSampleCount: number
  usableSampleCount: number
...
type PlacementFunctionConditionBatchWorstCondition = {
  conditionKey: string
  representativeSampleIndex: number | null
  candidateId: PlacementFunctionRoundtripCandidateId
  matrixNormalizedScore: number | null
...
type PlacementFunctionConditionBatchRoundtripComparisonState = {
  ...
  processedConditionCount: number
  totalRenderCount: number
  processedRenderCount: number
  candidateIds: PlacementFunctionRoundtripCandidateId[]
  currentConditionKey: string | null
  currentCandidateId: PlacementFunctionRoundtripCandidateId | null
  bestByRoundtripScoreCandidateId: PlacementFunctionRoundtripCandidateId | null
  bestByMatrixNormalizedScoreCandidateId: PlacementFunctionRoundtripCandidateId | null
...
type PlacementFunctionConditionBatchRoundtripComparisonSummary = Omit<
  PlacementFunctionConditionBatchRoundtripComparisonState,
  "previewPredictedLandmarks478"
>
...
type PlacementFunctionNumericStats = {
  min: number
  max: number
  range: number
  mean: number
...
type PlacementFunctionCandidateTrainingSample = {
  conditionKey: string
  knownPlacement: KnownPlacement
  basePlacement: BasePlacement
  targetPlacement: TargetPlacement
...
type PlacementFunctionConditionStats = {
  conditionKey: string
  usableSampleCount: number
  negTzMean: number | null
  negTzStdDev: number | null
  negTzRange: number | null
  invNegTzMean: number | null
  invNegTzStdDev: number | null
  invNegTzRange: number | null
}
...
type PlacementFunctionAnalysisState = {
  ...
  showBestComparisonRoundtrip478: boolean
  ...
  roundtripComparison: PlacementFunctionRoundtripComparisonState
  conditionBatchRoundtripComparison: PlacementFunctionConditionBatchRoundtripComparisonState
...
const PLACEMENT_ANALYSIS_CENTER_IMAGE_X_VALUES = [0.42, 0.46, 0.5, 0.54, 0.58] as const
const PLACEMENT_ANALYSIS_CENTER_IMAGE_Y_VALUES = [
  0.4,
  0.42,
  0.44,
  0.46,
  ...
  return `
    <div class="preview-card placement-analysis-preview-card" data-preview-panel="placementAnalysis">
      ...
      <div class="obj-preview-controls placement-analysis-preview-controls" aria-label="配置関数解析プレビュー操作">
        ...
        <label class="overlay-toggle">
          <input type="checkbox" data-control="placement-analysis-show-best-comparison-roundtrip-478" checked />
          <span>比較 / batch best candidate の再レンダー478を表示</span>
        </label>
        <label class="overlay-toggle">
...
function bindEvents() {
  ...
  app.addEventListener("click", (event) => {
    ...
    if (action === "placement-analysis-run-roundtrip-comparison") {
      void runSelectedPlacementFunctionRoundtripComparison()
    }
    if (action === "placement-analysis-run-condition-batch-roundtrip-comparison") {
      void runPlacementFunctionConditionBatchRoundtripComparison()
    }
    if (action === "placement-analysis-stop-condition-batch-roundtrip-comparison") {
      stopPlacementFunctionConditionBatchRoundtripComparison()
    }
  ...
  bindPlacementAnalysisPreviewToggle(
    "placement-analysis-show-best-comparison-roundtrip-478",
    "showBestComparisonRoundtrip478",
  )
...
async function startPlacementFunctionAnalysis() {
  if (
    state.placementAnalysis.status === "running" ||
...
function runPlacementFunctionRoundtripRenderDetect(
  sample: PlacementFunctionRoundtripInput,
  estimatedTransform: PlacementFunctionRoundtripEstimatedTransform,
  detector: FaceLandmarker,
  renderer: WebglObjRenderer,
  landmarkComparedTo: PlacementFunctionRoundtripLandmarkDiffSummary["comparedTo"] = "selected_sample_target478",
): PlacementFunctionRoundtripExecutionResult {
...
async function runSelectedPlacementFunctionRoundtripValidation() {
  if (
    state.placementAnalysis.roundtripPreview.status === "running" ||
    state.placementAnalysis.roundtripComparison.status === "running" ||
    state.placementAnalysis.conditionBatchRoundtripComparison.status === "running"
  ) {
    return
  }
...
async function runSelectedPlacementFunctionRoundtripComparison() {
  if (
    state.placementAnalysis.roundtripComparison.status === "running" ||
    state.placementAnalysis.roundtripPreview.status === "running" ||
    state.placementAnalysis.conditionBatchRoundtripComparison.status === "running"
  ...
  if (!sample || !candidate) {
    state.placementAnalysis = {
      ...state.placementAnalysis,
      roundtripComparison: {
        ...createDefaultPlacementFunctionRoundtripComparisonState(),
        status: "error",
        sampleIndex: sample?.sampleIndex ?? null,
        candidateIds,
        errorMessage: "選択中サンプルまたは配置関数候補がありません。",
  ...
  if (!canRenderRenderedIdealGeometry()) {
    state.placementAnalysis = {
      ...
      roundtripComparison: {
        ...
        sampleIndex: sample.sampleIndex,
        candidateIds,
        errorMessage: "OBJ読込を完了してから再レンダー候補比較を実行してください。",
      },
    }
    renderAll()
    return
  ...
  const results: PlacementFunctionRoundtripComparisonResult[] = []
  const previewLandmarksByCandidateId = new Map<PlacementFunctionRoundtripCandidateId, ReferenceLandmark[]>()
  try {
    const detector = await getRenderedIdealFaceLandmarker()
    const renderer = getOrCreatePlacementAnalysisRenderer()
    const availableCandidateIds = new Set(getPlacementFunctionRoundtripCandidateIds(candidate))

    for (const candidateId of candidateIds) {
      let comparisonResult: PlacementFunctionRoundtripComparisonResult
        ...
        if (!estimatedTransform) {
          ...
          try {
            ...
            if (roundtripResult.predictedLandmarks478ForPreview) {
              previewLandmarksByCandidateId.set(candidateId, roundtripResult.predictedLandmarks478ForPreview)
            }
          } catch (error) {
            const message = error instanceof Error ? error.message : String(error)
            comparisonResult = createPlacementFunctionRoundtripComparisonResult({
      ...
      state.placementAnalysis = {
        ...state.placementAnalysis,
        roundtripComparison: {
          ...state.placementAnalysis.roundtripComparison,
          results: [...results],
        },
      }
      renderDebugContent()
    ...
    const bestByRoundtripScoreCandidateId = getBestPlacementFunctionRoundtripComparisonCandidateId(
      results,
      "roundtripScore",
    )
    const bestByMatrixNormalizedScoreCandidateId = getBestPlacementFunctionRoundtripComparisonCandidateId(
      results,
      "matrixNormalizedScore",
    )
    const previewPredictedCandidateId = bestByRoundtripScoreCandidateId ?? bestByMatrixNormalizedScoreCandidateId
    state.placementAnalysis = {
      ...state.placementAnalysis,
      roundtripComparison: {
        status: "completed",
        ...
        previewPredictedCandidateId,
        previewPredictedLandmarks478: previewPredictedCandidateId
          ? previewLandmarksByCandidateId.get(previewPredictedCandidateId) ?? null
          : null,
        errorMessage: null,
      },
    }
    addLog(`再レンダー候補比較が完了しました: sample=${sample.sampleIndex}`)
  } catch (error) {
    const message = error instanceof Error ? error.message : String(error)
    state.placementAnalysis = {
      ...state.placementAnalysis,
      roundtripComparison: {
        ...
        previewPredictedCandidateId: null,
        previewPredictedLandmarks478: null,
        errorMessage: message,
      },
    }
    addLog(`再レンダー候補比較でエラーが発生しました: ${message}`)
  } finally {
    renderAll()
  }
}

async function runPlacementFunctionConditionBatchRoundtripComparison() {
  const batch = state.placementAnalysis.conditionBatchRoundtripComparison
  if (
    ...
    state.placementAnalysis = {
      ...
      conditionBatchRoundtripComparison: {
        ...
        errorMessage: candidate
          ? "条件単位の usable sample がありません。先に配置関数解析を完了してください。"
          : "配置関数候補がありません。先に配置関数解析を完了してください。",
      },
    }
    renderAll()
    return
  ...
  if (!canRenderRenderedIdealGeometry()) {
    state.placementAnalysis = {
      ...
      conditionBatchRoundtripComparison: {
        ...
        totalConditionCount: inputs.length,
        totalRenderCount: inputs.length * candidateIds.length,
        errorMessage: "OBJ読込を完了してから条件単位まとめ再レンダー比較を実行してください。",
      },
    }
    renderAll()
    return
  ...
  placementFunctionConditionBatchRoundtripCancelRequested = false
  state.placementAnalysis = {
    ...state.placementAnalysis,
    conditionBatchRoundtripComparison: {
      ...createDefaultPlacementFunctionConditionBatchRoundtripComparisonState(),
  ...
  try {
    ...
    for (const input of inputs) {
      if (placementFunctionConditionBatchRoundtripCancelRequested) {
        break
      }

      const conditionCandidateResults: PlacementFunctionRoundtripComparisonResult[] = []
      const previewLandmarksByCandidateId = new Map<PlacementFunctionRoundtripCandidateId, ReferenceLandmark[]>()
      let completedWholeCondition = true

      for (const candidateId of candidateIds) {
        if (placementFunctionConditionBatchRoundtripCancelRequested) {
          completedWholeCondition = false
          break
        }

        updatePlacementFunctionConditionBatchRoundtripState({
          status: "running",
          startedAtMs,
          startedAtPerformanceMs,
          processedConditionCount,
          processedRenderCount,
          totalConditionCount: inputs.length,
          totalRenderCount: inputs.length * candidateIds.length,
          candidateIds,
          currentConditionKey: input.conditionKey,
          currentCandidateId: candidateId,
          conditionResults: [
            ...conditionResults,
            createPlacementFunctionConditionBatchResult(input, conditionCandidateResults),
          ],
        })
        renderDebugContent()
          ...
          if (!estimatedTransform) {
            ...
            try {
              const roundtripResult = runPlacementFunctionRoundtripRenderDetect(
                ...
                detector,
                renderer,
                "representative_sample_target478",
              )
              comparisonResult = createPlacementFunctionRoundtripComparisonResult({
                candidateId,
                status: "completed",
        ...
        conditionCandidateResults.push(comparisonResult)
        processedRenderCount += 1
        updatePlacementFunctionConditionBatchRoundtripState({
          status: "running",
          startedAtMs,
          startedAtPerformanceMs,
      ...
      if (conditionCandidateResults.length > 0) {
        const conditionResult = createPlacementFunctionConditionBatchResult(input, conditionCandidateResults)
        conditionResults.push(conditionResult)
        if (completedWholeCondition) {
          processedConditionCount += 1
        }
        updatePlacementFunctionConditionBatchPreview(input, conditionResult, previewLandmarksByCandidateId)
        updatePlacementFunctionConditionBatchRoundtripState({
          status: "running",
          startedAtMs,
          startedAtPerformanceMs,
    ...
    const finalStatus: PlacementFunctionConditionBatchStatus = placementFunctionConditionBatchRoundtripCancelRequested
      ? "cancelled"
      : "completed"
    updatePlacementFunctionConditionBatchRoundtripState({
      status: finalStatus,
    ...
    addLog(
      finalStatus === "completed"
        ? `条件単位まとめ再レンダー比較が完了しました: ${processedConditionCount} conditions / ${processedRenderCount} render slots`
        : `条件単位まとめ再レンダー比較を中断しました: ${processedConditionCount} conditions / ${processedRenderCount} render slots`,
    )
  } catch (error) {
    const message = error instanceof Error ? error.message : String(error)
    console.error("Condition batch roundtrip comparison failed", error)
    updatePlacementFunctionConditionBatchRoundtripState({
      status: "error",
      startedAtMs,
      startedAtPerformanceMs,
    ...
    addLog(`条件単位まとめ再レンダー比較でエラーが発生しました: ${message}`)
  } finally {
    placementFunctionConditionBatchRoundtripCancelRequested = false
    renderAll()
  }
...
function stopPlacementFunctionConditionBatchRoundtripComparison() {
  if (state.placementAnalysis.conditionBatchRoundtripComparison.status !== "running") {
    return
  }
  placementFunctionConditionBatchRoundtripCancelRequested = true
}

function updatePlacementFunctionConditionBatchRoundtripState(input: {
  status: PlacementFunctionConditionBatchStatus
  startedAtMs: number
  ...
  const elapsedMs = performance.now() - input.startedAtPerformanceMs
  const remainingRenderCount = Math.max(0, input.totalRenderCount - input.processedRenderCount)
  const averageRenderMs = input.processedRenderCount > 0 ? elapsedMs / input.processedRenderCount : null
  const aggregate = buildPlacementFunctionConditionBatchRoundtripAggregate(
    input.candidateIds,
  ...
  state.placementAnalysis = {
    ...
    conditionBatchRoundtripComparison: {
      ...
      elapsedMs: roundForState(elapsedMs),
      estimatedRemainingMs:
        input.status === "running" && averageRenderMs !== null
          ? roundForState(averageRenderMs * remainingRenderCount)
          : 0,
      totalConditionCount: input.totalConditionCount,
      processedConditionCount: input.processedConditionCount,
      totalRenderCount: input.totalRenderCount,
      processedRenderCount: input.processedRenderCount,
      candidateIds: [...input.candidateIds],
      currentConditionKey: input.currentConditionKey,
      currentCandidateId: input.currentCandidateId,
      bestByRoundtripScoreCandidateId: aggregate.bestByRoundtripScoreCandidateId,
...
function updatePlacementFunctionConditionBatchPreview(
  input: PlacementFunctionConditionRoundtripInput,
  conditionResult: PlacementFunctionConditionBatchResult,
  previewLandmarksByCandidateId: Map<PlacementFunctionRoundtripCandidateId, ReferenceLandmark[]>,
) {
  const previewCandidateId =
    conditionResult.bestByRoundtripScoreCandidateId ?? conditionResult.bestByMatrixNormalizedScoreCandidateId
  const previewPredictedLandmarks478 = previewCandidateId
    ? previewLandmarksByCandidateId.get(previewCandidateId) ?? null
    : null
  state.placementAnalysis = {
    ...state.placementAnalysis,
    selectedSampleIndex: input.representativeSampleIndex,
    conditionBatchRoundtripComparison: {
      ...state.placementAnalysis.conditionBatchRoundtripComparison,
      previewConditionKey: input.conditionKey,
      previewCandidateId,
      previewRepresentativeSampleIndex: input.representativeSampleIndex,
      previewPredictedLandmarks478,
    },
  }

  const bestResult = conditionResult.results.find((result) => result.candidateId === previewCandidateId)
  if (bestResult?.estimatedTransform) {
    const knownPlacement = createKnownPlacementFromPlacementFunctionEstimatedTransform(
      input,
      bestResult.estimatedTransform,
    )
    renderPlacementAnalysisKnownPlacementToCanvas(knownPlacement, input.requestedPoseP)
  }
}

function createPlacementFunctionConditionBatchResult(
  input: PlacementFunctionConditionRoundtripInput,
  results: PlacementFunctionRoundtripComparisonResult[],
): PlacementFunctionConditionBatchResult {
  return {
    conditionKey: input.conditionKey,
    representativeSampleIndex: input.representativeSampleIndex,
    repeatSampleCount: input.repeatSampleCount,
    usableSampleCount: input.usableSampleCount,
    bestByRoundtripScoreCandidateId: getBestPlacementFunctionRoundtripComparisonCandidateId(
      results,
      "roundtripScore",
    ),
    bestByMatrixNormalizedScoreCandidateId: getBestPlacementFunctionRoundtripComparisonCandidateId(
      results,
      "matrixNormalizedScore",
    ),
    results: [...results],
...
function buildPlacementFunctionConditionBatchRoundtripAggregate(
  candidateIds: PlacementFunctionRoundtripCandidateId[],
  conditionResults: PlacementFunctionConditionBatchResult[],
) {
  const winCountsByCandidate = new Map<
    PlacementFunctionRoundtripCandidateId,
    { byRoundtripScore: number; byMatrixNormalizedScore: number }
  >()
  for (const candidateId of candidateIds) {
    winCountsByCandidate.set(candidateId, {
      byRoundtripScore: 0,
      byMatrixNormalizedScore: 0,
    })
  }
  for (const conditionResult of conditionResults) {
    const roundtripWinner = conditionResult.bestByRoundtripScoreCandidateId
    const matrixWinner = conditionResult.bestByMatrixNormalizedScoreCandidateId
    if (roundtripWinner) {
      const counts = winCountsByCandidate.get(roundtripWinner)
      if (counts) {
        counts.byRoundtripScore += 1
      }
    }
    if (matrixWinner) {
      const counts = winCountsByCandidate.get(matrixWinner)
      if (counts) {
        counts.byMatrixNormalizedScore += 1
      }
    }
  }
  ...
  const candidateSummaries = candidateIds.map((candidateId) => {
    ...
    const wins = winCountsByCandidate.get(candidateId) ?? {
      byRoundtripScore: 0,
      byMatrixNormalizedScore: 0,
    }
    return {
      ...
      detectedCount: results.filter((result) => result.predictedMediaPipeResult?.detected === true).length,
      noFaceCount: results.filter((result) => result.status === "completed" && result.predictedMediaPipeResult?.detected === false).length,
      matrixNormalizedScore: summarizePlacementFunctionConditionBatchFullScores(
        results.map((result) => result.scores.matrixNormalizedScore),
      ),
      roundtripScore: summarizePlacementFunctionConditionBatchFullScores(
        results.map((result) => result.scores.roundtripScore),
      ),
      matrixRawTranslationScore: summarizePlacementFunctionConditionBatchCompactScores(
        results.map((result) => result.scores.matrixRawTranslationScore),
      ),
      poseScore: summarizePlacementFunctionConditionBatchCompactScores(
        results.map((result) => result.scores.poseScore),
      ),
      landmarkScore: summarizePlacementFunctionConditionBatchCompactScores(
        results.map((result) => result.scores.landmarkScore),
      ),
      winCounts: wins,
    }
  })

  const worstConditions = conditionResults
    .flatMap((conditionResult) =>
      conditionResult.results.map((result) => ({
        ...
        poseScore: result.scores.poseScore,
        landmarkScore: result.scores.landmarkScore,
        matrixError: result.matrixError,
        poseError: result.poseError,
        estimatedTransform: result.estimatedTransform,
      })),
    )
    .filter((item) => isFiniteNumber(item.roundtripScore))
  ...
  return {
    ...
    bestByMatrixNormalizedScoreCandidateId: getBestPlacementFunctionConditionBatchSummaryCandidateId(
      candidateSummaries,
      "matrixNormalizedScore",
    ),
  }
...
function getBestPlacementFunctionConditionBatchSummaryCandidateId(
  ...
  scoreKey: "matrixNormalizedScore" | "roundtripScore",
): PlacementFunctionRoundtripCandidateId | null {
  const rankedSummaries = [...summaries]
    .filter((summary) => isFiniteNumber(summary[scoreKey].mean))
    .sort((a, b) => (a[scoreKey].mean ?? Number.POSITIVE_INFINITY) - (b[scoreKey].mean ?? Number.POSITIVE_INFINITY))
  return rankedSummaries[0]?.candidateId ?? null
}

function summarizePlacementFunctionConditionBatchFullScores(
  values: Array<number | null>,
): PlacementFunctionConditionBatchFullScoreStats {
  ...
  return {
    mean: roundForState(averageFiniteNumbers(finiteValues)),
    p50: calculatePlacementFunctionConditionBatchPercentile(finiteValues, 0.5),
    p90: calculatePlacementFunctionConditionBatchPercentile(finiteValues, 0.9),
    p95: calculatePlacementFunctionConditionBatchPercentile(finiteValues, 0.95),
    max: roundForState(finiteValues[finiteValues.length - 1]),
  }
}

function summarizePlacementFunctionConditionBatchCompactScores(
  values: Array<number | null>,
): PlacementFunctionConditionBatchCompactScoreStats {
  const fullStats = summarizePlacementFunctionConditionBatchFullScores(values)
  return {
    mean: fullStats.mean,
    p95: fullStats.p95,
    max: fullStats.max,
...
function calculatePlacementFunctionConditionBatchPercentile(values: number[], percentile: number) {
  if (values.length === 0) {
    return null
  }
  const clamped = clamp(percentile, 0, 1)
  const index = Math.min(values.length - 1, Math.max(0, Math.ceil(clamped * values.length) - 1))
  return roundForState(values[index])
}
...
function createPlacementFunctionAnalysisPlans(options: PlacementFunctionAnalysisRunOptions) {
  ...
  const repeatCount = Math.max(1, Math.floor(options.repeatCount))
  for (const centerImageY of options.centerImageYValues) {
    for (const centerImageX of options.centerImageXValues) {
      for (const visualScaleInput of options.visualScaleInputValues) {
        const knownPlacement = createKnownPlacement({
          centerImageX,
          centerImageY,
          visualScaleInput,
          options,
        })
        const conditionKey = createPlacementFunctionConditionKey({
          centerImageX,
          centerImageY,
          visualScaleInput,
...
function createPlacementFunctionConditionKey(input: {
  centerImageX: number
  centerImageY: number
  visualScaleInput: number
  poseSet: PlacementFunctionAnalysisRunOptions["poseSet"]
}) {
  return [
    `x=${input.centerImageX.toFixed(3)}`,
    `y=${input.centerImageY.toFixed(3)}`,
    `scale=${input.visualScaleInput.toFixed(3)}`,
    `pose=${input.poseSet}`,
  ].join("_")
}
...
function appendPlacementFunctionAnalysisSample(sample: PlacementFunctionAnalysisSampleState) {
  ...
  const summary = createPlacementFunctionAnalysisSummary(
    samples,
    state.placementAnalysis.runOptions,
...
function createPlacementFunctionAnalysisSummary(
  samples: PlacementFunctionAnalysisSampleState[],
  options: PlacementFunctionAnalysisRunOptions,
  candidate: PlacementFunctionCandidate | null = null,
...
function buildPlacementFunctionRepeatSummary(
  samples: PlacementFunctionAnalysisSampleState[],
  options: PlacementFunctionAnalysisRunOptions,
  candidate: PlacementFunctionCandidate | null,
): PlacementFunctionRepeatSummary {
  const usableSamples = getUsablePlacementFunctionAnalysisSamples(samples)
  const conditionGroups = groupPlacementFunctionSamplesByCondition(usableSamples)
  return {
    repeatCount: Math.max(1, Math.floor(options.repeatCount)),
    uniqueConditionCount: countUniquePlacementFunctionConditions(samples),
    sampleCount: samples.length,
    usableSampleCount: usableSamples.length,
    negTzWithinCondition: summarizePlacementFunctionWithinCondition(
      conditionGroups,
      (sample) => sample.matrixFeatures.negTz,
    ),
    invNegTzWithinCondition: summarizePlacementFunctionWithinCondition(
      conditionGroups,
      (sample) => sample.matrixFeatures.invNegTz,
    ),
    scaleRatioWithinCondition: candidate
      ? summarizePlacementFunctionEstimatedScaleWithinCondition(conditionGroups, candidate)
      : {},
  }
}

function buildPlacementFunctionPositionCorrelationSummary(
  samples: PlacementFunctionAnalysisSampleState[],
): PlacementFunctionPositionCorrelationSummary[] {
  const byScale = groupPlacementFunctionSamplesByScaleRatio(
    getUsablePlacementFunctionAnalysisSamples(samples),
  )
  return Array.from(byScale.values())
    .map((scaleSamples) => {
      const negTzStats = calculatePlacementFunctionNumericStats(
        scaleSamples.map((sample) => sample.matrixFeatures.negTz),
      )
      if (!negTzStats) {
        return null
      }
      return {
        scaleRatio: roundForState(scaleSamples[0].knownTransform.scaleRatio) ?? 0,
        usableSampleCount: scaleSamples.length,
        corrCenterImageXNegTz: calculatePlacementFunctionCorrelation(
          scaleSamples.map((sample) => sample.knownPlacement.centerImageX),
          scaleSamples.map((sample) => sample.matrixFeatures.negTz),
        ),
        corrCenterImageYNegTz: calculatePlacementFunctionCorrelation(
          scaleSamples.map((sample) => sample.knownPlacement.centerImageY),
          scaleSamples.map((sample) => sample.matrixFeatures.negTz),
        ),
        corrCenterImageXInvNegTz: calculatePlacementFunctionCorrelation(
          scaleSamples.map((sample) => sample.knownPlacement.centerImageX),
          scaleSamples.map((sample) => sample.matrixFeatures.invNegTz),
        ),
        corrCenterImageYInvNegTz: calculatePlacementFunctionCorrelation(
          scaleSamples.map((sample) => sample.knownPlacement.centerImageY),
          scaleSamples.map((sample) => sample.matrixFeatures.invNegTz),
        ),
        negTzMin: negTzStats.min,
        negTzMax: negTzStats.max,
        negTzRange: negTzStats.range,
        negTzMean: negTzStats.mean,
        negTzStdDev: negTzStats.stdDev,
      }
    })
    .filter((item): item is PlacementFunctionPositionCorrelationSummary => item !== null)
    .sort((a, b) => a.scaleRatio - b.scaleRatio)
}

function buildPlacementFunctionVerticalPositionSummary(
  samples: PlacementFunctionAnalysisSampleState[],
): PlacementFunctionVerticalPositionSummary[] {
  const byScaleAndY = new Map<string, PlacementFunctionAnalysisSampleState[]>()
  for (const sample of getUsablePlacementFunctionAnalysisSamples(samples)) {
    const key = [
      formatPlacementScaleKey(sample.knownTransform.scaleRatio),
      formatPlacementScaleKey(sample.knownPlacement.centerImageY),
    ].join("|")
    byScaleAndY.set(key, [...(byScaleAndY.get(key) ?? []), sample])
  }
  return Array.from(byScaleAndY.values())
    .map((groupSamples) => {
      const negTzStats = calculatePlacementFunctionNumericStats(
        groupSamples.map((sample) => sample.matrixFeatures.negTz),
      )
      const invNegTzStats = calculatePlacementFunctionNumericStats(
        groupSamples.map((sample) => sample.matrixFeatures.invNegTz),
      )
      if (!negTzStats || !invNegTzStats) {
        return null
      }
      return {
        scaleRatio: roundForState(groupSamples[0].knownTransform.scaleRatio) ?? 0,
        centerImageY: roundForState(groupSamples[0].knownPlacement.centerImageY) ?? 0,
        usableSampleCount: groupSamples.length,
        negTzMin: negTzStats.min,
        negTzMax: negTzStats.max,
        negTzRange: negTzStats.range,
        negTzMean: negTzStats.mean,
        negTzStdDev: negTzStats.stdDev,
        invNegTzMean: invNegTzStats.mean,
        invNegTzStdDev: invNegTzStats.stdDev,
      }
    })
    .filter((item): item is PlacementFunctionVerticalPositionSummary => item !== null)
    .sort((a, b) => a.scaleRatio - b.scaleRatio || a.centerImageY - b.centerImageY)
}

function getUsablePlacementFunctionAnalysisSamples(samples: PlacementFunctionAnalysisSampleState[]) {
  return samples.filter((sample) => sample.quality.usable)
}

function groupPlacementFunctionSamplesByCondition(samples: PlacementFunctionAnalysisSampleState[]) {
  const byCondition = new Map<string, PlacementFunctionAnalysisSampleState[]>()
  for (const sample of samples) {
    byCondition.set(sample.conditionKey, [...(byCondition.get(sample.conditionKey) ?? []), sample])
  }
  return byCondition
}

function groupPlacementFunctionSamplesByScaleRatio(samples: PlacementFunctionAnalysisSampleState[]) {
  const byScale = new Map<string, PlacementFunctionAnalysisSampleState[]>()
  for (const sample of samples) {
    const key = formatPlacementScaleKey(sample.knownTransform.scaleRatio)
    byScale.set(key, [...(byScale.get(key) ?? []), sample])
  }
  return byScale
}

function countUniquePlacementFunctionConditions(samples: PlacementFunctionAnalysisSampleState[]) {
  return new Set(samples.map((sample) => sample.conditionKey)).size
}

function summarizePlacementFunctionWithinCondition(
  conditionGroups: Map<string, PlacementFunctionAnalysisSampleState[]>,
  getValue: (sample: PlacementFunctionAnalysisSampleState) => number | null | undefined,
) {
  const ranges: number[] = []
  const stdDevs: number[] = []
  for (const groupSamples of conditionGroups.values()) {
    const stats = calculatePlacementFunctionNumericStats(groupSamples.map(getValue))
    if (!stats) {
      continue
    }
    ranges.push(stats.range)
    stdDevs.push(stats.stdDev)
  }
  return {
    meanRange: roundForState(averageFiniteNumbers(ranges) ?? 0) ?? 0,
    maxRange: roundForState(maxNumbers(ranges) ?? 0) ?? 0,
    meanStdDev: roundForState(averageFiniteNumbers(stdDevs) ?? 0) ?? 0,
    maxStdDev: roundForState(maxNumbers(stdDevs) ?? 0) ?? 0,
  }
}

function summarizePlacementFunctionEstimatedScaleWithinCondition(
  conditionGroups: Map<string, PlacementFunctionAnalysisSampleState[]>,
  candidate: PlacementFunctionCandidate,
): PlacementFunctionRepeatSummary["scaleRatioWithinCondition"] {
  const ranges: number[] = []
  for (const groupSamples of conditionGroups.values()) {
    const stats = calculatePlacementFunctionNumericStats(
      groupSamples.map((sample) => predictPlacementFunctionCandidateScaleRatio(candidate, sample)),
    )
    if (!stats) {
      continue
    }
  ...
  return {
    meanEstimatedRange: roundForState(averageFiniteNumbers(ranges) ?? 0) ?? 0,
    maxEstimatedRange: roundForState(maxNumbers(ranges) ?? 0) ?? 0,
  }
}

function buildPlacementFunctionConditionStats(
  samples: PlacementFunctionAnalysisSampleState[],
): Map<string, PlacementFunctionConditionStats> {
  const conditionStats = new Map<string, PlacementFunctionConditionStats>()
  for (const [conditionKey, groupSamples] of groupPlacementFunctionSamplesByCondition(
    getUsablePlacementFunctionAnalysisSamples(samples),
  )) {
    const negTzStats = calculatePlacementFunctionNumericStats(
      groupSamples.map((sample) => sample.matrixFeatures.negTz),
    ...
    conditionStats.set(conditionKey, {
      conditionKey,
      usableSampleCount: groupSamples.length,
      negTzMean: negTzStats?.mean ?? null,
      negTzStdDev: negTzStats?.stdDev ?? null,
      negTzRange: negTzStats?.range ?? null,
      invNegTzMean: invNegTzStats?.mean ?? null,
      invNegTzStdDev: invNegTzStats?.stdDev ?? null,
      invNegTzRange: invNegTzStats?.range ?? null,
    })
  }
  return conditionStats
}

function calculatePlacementFunctionNumericStats(
  values: Array<number | null | undefined>,
): PlacementFunctionNumericStats | null {
  const finiteValues = values
    .filter((value): value is number => typeof value === "number" && Number.isFinite(value))
    .sort((a, b) => a - b)
  if (finiteValues.length === 0) {
  ...
  const mean = averageFiniteNumbers(finiteValues) ?? 0
  const variance = averageFiniteNumbers(finiteValues.map((value) => (value - mean) ** 2)) ?? 0
  return {
    min: roundForState(min) ?? 0,
    max: roundForState(max) ?? 0,
    range: roundForState(max - min) ?? 0,
    mean: roundForState(mean) ?? 0,
    stdDev: roundForState(Math.sqrt(variance)) ?? 0,
  }
}

function calculatePlacementFunctionCorrelation(
  ...
  const meanX = averageFiniteNumbers(pairs.map((pair) => pair.x)) ?? 0
  const meanY = averageFiniteNumbers(pairs.map((pair) => pair.y)) ?? 0
  const numerator = pairs.reduce((sum, pair) => sum + (pair.x - meanX) * (pair.y - meanY), 0)
  const xVarianceSum = pairs.reduce((sum, pair) => sum + (pair.x - meanX) ** 2, 0)
  const yVarianceSum = pairs.reduce((sum, pair) => sum + (pair.y - meanY) ** 2, 0)
  const denominator = Math.sqrt(xVarianceSum * yVarianceSum)
  if (!Number.isFinite(denominator) || denominator <= 1e-12) {
    return null
  }
  return roundForState(numerator / denominator)
}
...
function buildPlacementFunctionCandidate(samples: PlacementFunctionAnalysisSampleState[]): {
  ...
  const fittingSamples = createPlacementFunctionConditionMeanFittingSamples(usableSamples)
  if (fittingSamples.length < 2) {
    return { candidate: null, reason: "usable sample count too small" }
  }
  const targetCenterImageXModel = fitSimpleLinearModel(
    fittingSamples.map((sample) => ({
  ...
  return {
    ...
    candidate: {
      ...
      source: {
        ...
        usableSampleCount: usableSamples.length,
        uniqueConditionCount: countUniquePlacementFunctionConditions(samples),
        fittingSampleCount: fittingSamples.length,
        fittingAggregation: "condition_mean",
      },
      targetCoordinateSpace: "image_normalized_coordinate",
      transformOrder: "scale_then_translate",
...
function createPlacementFunctionConditionMeanFittingSamples(
  usableSamples: PlacementFunctionAnalysisSampleState[],
): PlacementFunctionCandidateTrainingSample[] {
  return Array.from(groupPlacementFunctionSamplesByCondition(usableSamples).entries())
    .map(([conditionKey, conditionSamples]) => {
      const first = conditionSamples[0]
      return {
        conditionKey,
...
function createPlacementFunctionConditionBatchRoundtripInputs(
  samples: PlacementFunctionAnalysisSampleState[],
): PlacementFunctionConditionRoundtripInput[] {
  return Array.from(groupPlacementFunctionSamplesByCondition(getUsablePlacementFunctionAnalysisSamples(samples)).entries())
    .map(([conditionKey, conditionSamples]) => {
      const first = conditionSamples[0]
      return {
        conditionKey,
        representativeSampleIndex: first.sampleIndex,
        repeatSampleCount: first.repeatCount,
        usableSampleCount: conditionSamples.length,
        knownPlacement: first.knownPlacement,
        basePlacement: first.basePlacement,
        targetPlacement: first.targetPlacement,
        knownTransform: averagePlacementFunctionKnownTransform(
        ...
        requestedPoseP: cloneObjPoseMappingPose(first.requestedPoseP),
        mediaPipeResult: {
          returnedPose: averagePlacementFunctionReturnedPose(
            conditionSamples.map((sample) => sample.mediaPipeResult.returnedPose ?? null),
          ),
        },
        previewLandmarks478: first.previewLandmarks478,
      }
    })
    .sort((a, b) => a.conditionKey.localeCompare(b.conditionKey))
}

function averagePlacementFunctionReturnedPose(
  poses: Array<PlacementFunctionAnalysisSample["mediaPipeResult"]["returnedPose"] | null>,
) {
  const yaw = averagePlacementFunctionNullableFeature(poses.map((pose) => pose?.yaw ?? null))
  const pitch = averagePlacementFunctionNullableFeature(poses.map((pose) => pose?.pitch ?? null))
  const roll = averagePlacementFunctionNullableFeature(poses.map((pose) => pose?.roll ?? null))
...
function averagePlacementFunctionMatrixFeatures(
  ...
  return {
    tx: averagePlacementFunctionNullableFeature(features.map((feature) => feature.tx)),
    ty: averagePlacementFunctionNullableFeature(features.map((feature) => feature.ty)),
    tz: averagePlacementFunctionNullableFeature(features.map((feature) => feature.tz)),
    negTz: averagePlacementFunctionNullableFeature(features.map((feature) => feature.negTz)),
    invNegTz: averagePlacementFunctionNullableFeature(features.map((feature) => feature.invNegTz)),
    txOverNegTz: averagePlacementFunctionNullableFeature(features.map((feature) => feature.txOverNegTz)),
    tyOverNegTz: averagePlacementFunctionNullableFeature(features.map((feature) => feature.tyOverNegTz)),
    matrixUniformScale: averagePlacementFunctionNullableFeature(features.map((feature) => feature.matrixUniformScale)),
  }
}

function averagePlacementFunctionNullableFeature(values: Array<number | null>) {
  const finiteValues = values.filter((value): value is number => value !== null && Number.isFinite(value))
  return roundForState(averageFiniteNumbers(finiteValues))
}
...
function predictPlacementFunctionCandidateScaleRatio(
  candidate: PlacementFunctionCandidate,
  sample: { matrixFeatures: PlacementFunctionMatrixFeatures },
) {
  return predictSimpleLinearModel(
    {
...
function predictPlacementFunctionCandidateForSample(
  ...
  const estimatedScaleRatio = predictPlacementFunctionCandidateScaleRatio(candidate, sample)
...
function hasPlacementFunctionRoundtripComparisonPreviewForSample(
  sample: PlacementFunctionAnalysisSampleState | null,
) {
  const comparison = state.placementAnalysis.roundtripComparison
  return (
    sample !== null &&
    comparison.status === "completed" &&
    comparison.sampleIndex === sample.sampleIndex &&
    comparison.previewPredictedLandmarks478 !== null
  )
}

function hasPlacementFunctionConditionBatchRoundtripPreviewForSample(
  sample: PlacementFunctionAnalysisSampleState | null,
) {
  const batch = state.placementAnalysis.conditionBatchRoundtripComparison
  return (
    sample !== null &&
    batch.previewRepresentativeSampleIndex === sample.sampleIndex &&
    batch.previewPredictedLandmarks478 !== null
  )
}
...
function createKnownPlacementFromPlacementFunctionEstimatedTransform(
  sample: Pick<PlacementFunctionRoundtripInput, "basePlacement" | "knownPlacement">,
  transform: PlacementFunctionRoundtripEstimatedTransform,
): KnownPlacement {
  const centerImageX =
...
function calculatePlacementFunctionRoundtripLandmarkDiffSummary(
  ...
  comparedTo?: PlacementFunctionRoundtripLandmarkDiffSummary["comparedTo"],
...
function createPlacementFunctionRoundtripComparisonResult(
  input: {
    candidateId: PlacementFunctionRoundtripCandidateId
...
): PlacementFunctionRoundtripComparisonResult {
  const matrixError = input.matrixError ?? null
  const poseError = input.poseError ?? null
  const landmarkDiffSummary = input.landmarkDiffSummary ?? null
  return {
    ...
    poseError,
    landmarkDiffSummary,
    scores: calculatePlacementFunctionRoundtripComparisonScores(matrixError, poseError, landmarkDiffSummary),
  }
}

function calculatePlacementFunctionRoundtripComparisonScores(
  matrixError: PlacementFunctionRoundtripMatrixError | null,
  poseError: PlacementFunctionRoundtripPoseError | null,
  landmarkDiffSummary: PlacementFunctionRoundtripLandmarkDiffSummary | null,
): PlacementFunctionRoundtripComparisonScores {
  const matrixNormalizedScore = sumNullableNumbers(
    matrixError?.absTxOverNegTzError ?? null,
    matrixError?.absTyOverNegTzError ?? null,
    multiplyNullable(matrixError?.absInvNegTzError ?? null, 100),
  )
  const matrixRawTranslationScore = sumNullableNumbers(
    matrixError?.absTxError ?? null,
    matrixError?.absTyError ?? null,
    matrixError?.absTzError ?? null,
  )
  const poseScore = poseError?.poseDiffMagnitude ?? null
  const landmarkScore = landmarkDiffSummary?.mean2dDistance ?? null
  return {
    matrixNormalizedScore,
    matrixRawTranslationScore,
    poseScore,
    landmarkScore,
    roundtripScore: matrixNormalizedScore === null
      ? null
      : roundForState(matrixNormalizedScore + (poseScore ?? 0) * 0.01 + (landmarkScore ?? 0)),
  }
}
...
function sumNullableNumbers(...values: Array<number | null>) {
  ...
  return roundForState(values.reduce((sum, value) => sum + (value ?? 0), 0))
}

function multiplyNullable(value: number | null, factor: number) {
  return value === null || !Number.isFinite(value) ? null : roundForState(value * factor)
}
...
function getBestPlacementFunctionRoundtripComparisonCandidateId(
  results: PlacementFunctionRoundtripComparisonResult[],
  scoreKey: keyof Pick<
    PlacementFunctionRoundtripComparisonScores,
    "matrixNormalizedScore" | "roundtripScore"
  >,
): PlacementFunctionRoundtripCandidateId | null {
  const rankedResults = [...results]
    .filter((result) => result.status === "completed" && isFiniteNumber(result.scores[scoreKey]))
    .sort((a, b) => (a.scores[scoreKey] ?? Number.POSITIVE_INFINITY) - (b.scores[scoreKey] ?? Number.POSITIVE_INFINITY))
  return rankedResults[0]?.candidateId ?? null
}
...
function getPlacementFunctionAnalysisRawSummary() {
  return {
    ...
    roundtripComparison: stripPlacementFunctionRoundtripComparisonState(state.placementAnalysis.roundtripComparison),
    conditionBatchRoundtripComparison: stripPlacementFunctionConditionBatchRoundtripComparisonState(
      state.placementAnalysis.conditionBatchRoundtripComparison,
    ),
  }
}
...
function createDefaultPlacementFunctionAnalysisState(): PlacementFunctionAnalysisState {
  ...
  return {
    ...
    showBestComparisonRoundtrip478: true,
    selectedRoundtripCandidateId: null,
    roundtripPreview: createDefaultPlacementFunctionRoundtripPreviewState(),
    roundtripComparison: createDefaultPlacementFunctionRoundtripComparisonState(),
    conditionBatchRoundtripComparison: createDefaultPlacementFunctionConditionBatchRoundtripComparisonState(),
...
function createDefaultPlacementFunctionRoundtripComparisonState(): PlacementFunctionRoundtripComparisonState {
  return {
    status: "idle",
    sampleIndex: null,
...
function createDefaultPlacementFunctionAnalysisRunOptions(): PlacementFunctionAnalysisRunOptions {
  ...
  return {
    centerImageXValues: [...PLACEMENT_ANALYSIS_CENTER_IMAGE_X_VALUES],
    centerImageYValues: [...PLACEMENT_ANALYSIS_CENTER_IMAGE_Y_VALUES],
    visualScaleInputValues: [...PLACEMENT_ANALYSIS_SCALE_VALUES],
    repeatCount: PLACEMENT_ANALYSIS_DEFAULT_REPEAT_COUNT,
    poseSet: "front",
...
function renderPlacementAnalysisPreviewPanel() {
  ...
  const showBestComparisonRoundtrip478Input = getElement<HTMLInputElement>(
    '[data-control="placement-analysis-show-best-comparison-roundtrip-478"]',
  )
  ...
  const hasSelectedBestComparison = hasPlacementFunctionRoundtripComparisonPreviewForSample(selectedSample)
  const hasSelectedBatchPreview = hasPlacementFunctionConditionBatchRoundtripPreviewForSample(selectedSample)
  const previewPredictedCandidateId = hasSelectedBestComparison
    ? state.placementAnalysis.roundtripComparison.previewPredictedCandidateId
    : null
  ...
  showBestComparisonRoundtrip478Input.checked = state.placementAnalysis.showBestComparisonRoundtrip478
  ...
  showBestComparisonRoundtrip478Input.disabled = !hasSelectedBestComparison && !hasSelectedBatchPreview
  ...
  summary.innerHTML = `
    <dl class="obj-preview-list placement-analysis-preview-list">
      ...
      <div><dt>previewPredictedCandidateId</dt><dd>${previewPredictedCandidateId ?? "-"}</dd></div>
      <div><dt>Batch preview conditionKey</dt><dd>${escapeHtml(hasSelectedBatchPreview ? state.placementAnalysis.conditionBatchRoundtripComparison.previewConditionKey ?? "-" : "-")}</dd></div>
      <div><dt>Batch preview candidateId</dt><dd>${escapeHtml(hasSelectedBatchPreview ? state.placementAnalysis.conditionBatchRoundtripComparison.previewCandidateId ?? "-" : "-")}</dd></div>
...
function renderPlacementAnalysisSamplePreview(sample: PlacementFunctionAnalysisSampleState) {
  const roundtrip = hasPlacementFunctionRoundtripPreviewForSample(sample)
    ...
    : null
  const batch = hasPlacementFunctionConditionBatchRoundtripPreviewForSample(sample)
    ? state.placementAnalysis.conditionBatchRoundtripComparison
    : null
  const batchResult = batch?.conditionResults
    .find((conditionResult) => conditionResult.conditionKey === batch.previewConditionKey)
    ?.results.find((result) => result.candidateId === batch.previewCandidateId) ?? null
  const knownPlacement = roundtrip?.estimatedTransform
    ...
    : batchResult?.estimatedTransform
      ? createKnownPlacementFromPlacementFunctionEstimatedTransform(sample, batchResult.estimatedTransform)
...
function drawPlacementAnalysisOverlay(sample: PlacementFunctionAnalysisSampleState | null) {
  ...
  const bestComparisonPredictedLandmarks = hasPlacementFunctionRoundtripComparisonPreviewForSample(sample)
    ? state.placementAnalysis.roundtripComparison.previewPredictedLandmarks478
    : null
  const batchPredictedLandmarks = hasPlacementFunctionConditionBatchRoundtripPreviewForSample(sample)
    ? state.placementAnalysis.conditionBatchRoundtripComparison.previewPredictedLandmarks478
    : null
  ...
  if (state.placementAnalysis.showBestComparisonRoundtrip478 && bestComparisonPredictedLandmarks) {
    drawLandmarkPoints(
      context,
      contentRect,
      bestComparisonPredictedLandmarks,
      "rgba(219, 39, 119, 0.92)",
      1.45,
    )
  }
  if (state.placementAnalysis.showBestComparisonRoundtrip478 && batchPredictedLandmarks) {
    drawLandmarkPoints(
      context,
      contentRect,
      batchPredictedLandmarks,
      "rgba(22, 163, 74, 0.92)",
      1.45,
    )
  }
...
function renderPlacementFunctionAnalysisDebugTab() {
  ...
  const canRunRoundtrip =
    ...
    analysis.roundtripComparison.status !== "running" &&
    analysis.conditionBatchRoundtripComparison.status !== "running" &&
    canRenderRenderedIdealGeometry()
  const canRunRoundtripComparison =
    Boolean(analysis.candidate) &&
    analysis.selectedSampleIndex !== null &&
    analysis.roundtripPreview.status !== "running" &&
    analysis.roundtripComparison.status !== "running" &&
    analysis.conditionBatchRoundtripComparison.status !== "running" &&
    canRenderRenderedIdealGeometry()
  const canRunConditionBatchRoundtripComparison =
    Boolean(analysis.candidate) &&
  ...
  container.innerHTML = `
    <section class="review-card">
      ...
      <div class="button-row placement-analysis-buttons">
        ...
        <button class="small-button" type="button" data-action="placement-analysis-run-roundtrip-comparison" ${canRunRoundtripComparison ? "" : "disabled"}>候補をまとめて再レンダー比較</button>
        <button class="small-button" type="button" data-action="placement-analysis-run-condition-batch-roundtrip-comparison" ${canRunConditionBatchRoundtripComparison ? "" : "disabled"}>条件単位で候補をまとめて再レンダー比較</button>
        <button class="small-button" type="button" data-action="placement-analysis-stop-condition-batch-roundtrip-comparison" ${analysis.conditionBatchRoundtripComparison.status === "running" ? "" : "disabled"}>比較を中断</button>
      </div>
    ...
    <section class="review-card">
      <h3>位置相関</h3>
      ${renderPlacementPositionCorrelationSummaryHtml(summary.positionCorrelationSummary)}
    </section>
    <section class="review-card">
      <h3>縦位置別要約</h3>
      ${renderPlacementVerticalPositionSummaryHtml(summary.verticalPositionSummary)}
    </section>
    <section class="review-card">
      <h3>スケール別検出要約</h3>
    ...
    <section class="review-card">
      ...
      <dl class="review-grid">
        ...
        <div><dt>fittingAggregation</dt><dd>${analysis.candidate?.source.fittingAggregation ?? "-"}</dd></div>
        <div><dt>fittingSampleCount</dt><dd>${analysis.candidate?.source.fittingSampleCount ?? "-"}</dd></div>
        <div><dt>uniqueConditionCount</dt><dd>${analysis.candidate?.source.uniqueConditionCount ?? "-"}</dd></div>
    ...
    <section class="review-card">
      <h3>Roundtrip Candidate Comparison（再レンダー候補比較）</h3>
      ${renderPlacementFunctionRoundtripComparisonHtml(analysis.roundtripComparison)}
    </section>
    <section class="review-card">
      <h3>Condition Batch Roundtrip Comparison（条件単位まとめ再レンダー比較）</h3>
      ${renderPlacementFunctionConditionBatchRoundtripComparisonHtml(analysis.conditionBatchRoundtripComparison)}
    </section>
  `
  return container
}
...
function formatLatestPlacementAnalysisSamplePreview() {
  ...
  return `#${sample.sampleIndex} repeat=${sample.repeatIndex + 1}/${sample.repeatCount} / condition=${sample.conditionKey} / ${formatKnownTransformShort(sample.knownTransform)} / ${formatKnownPlacementShort(sample.knownPlacement)} / detected=${String(sample.mediaPipeResult.detected)} / matrix=${String(sample.facialTransformationMatrix.available)}`
}
...
function renderPlacementRepeatSummaryHtml(summary: PlacementFunctionRepeatSummary) {
  return `
    <dl class="review-grid">
      <div><dt>repeatCount</dt><dd>${formatNullableCount(summary.repeatCount)}</dd></div>
      <div><dt>uniqueConditionCount</dt><dd>${formatNullableCount(summary.uniqueConditionCount)}</dd></div>
      <div><dt>sampleCount</dt><dd>${formatNullableCount(summary.sampleCount)}</dd></div>
      <div><dt>usableSampleCount</dt><dd>${formatNullableCount(summary.usableSampleCount)}</dd></div>
      <div><dt>negTz mean range</dt><dd>${formatNullableNumber(summary.negTzWithinCondition.meanRange)}</dd></div>
      <div><dt>negTz max range</dt><dd>${formatNullableNumber(summary.negTzWithinCondition.maxRange)}</dd></div>
      <div><dt>negTz mean stdDev</dt><dd>${formatNullableNumber(summary.negTzWithinCondition.meanStdDev)}</dd></div>
      <div><dt>negTz max stdDev</dt><dd>${formatNullableNumber(summary.negTzWithinCondition.maxStdDev)}</dd></div>
      <div><dt>invNegTz mean range</dt><dd>${formatNullableNumber(summary.invNegTzWithinCondition.meanRange)}</dd></div>
      <div><dt>invNegTz max range</dt><dd>${formatNullableNumber(summary.invNegTzWithinCondition.maxRange)}</dd></div>
      <div><dt>scaleRatio estimated mean range</dt><dd>${formatNullableNumber(summary.scaleRatioWithinCondition.meanEstimatedRange ?? null)}</dd></div>
      <div><dt>scaleRatio estimated max range</dt><dd>${formatNullableNumber(summary.scaleRatioWithinCondition.maxEstimatedRange ?? null)}</dd></div>
    </dl>
  `
}

function renderPlacementPositionCorrelationSummaryHtml(
  summary: PlacementFunctionPositionCorrelationSummary[],
) {
  if (summary.length === 0) {
    return `<p class="placeholder-text">解析実行後に scaleRatio ごとの位置相関を表示します。</p>`
  }
  return `
    <div class="table-scroll">
      <table class="debug-table placement-analysis-summary-table">
        <thead>
          <tr>
            <th>scaleRatio</th>
            <th>usable</th>
            <th>corr(centerImageY, -tz)</th>
            <th>corr(centerImageX, -tz)</th>
            <th>corr(centerImageY, invNegTz)</th>
            <th>corr(centerImageX, invNegTz)</th>
            <th>negTz mean</th>
            <th>negTz range</th>
            <th>negTz stdDev</th>
          </tr>
        ...
        <tbody>
          ${summary.map((item) => `
            <tr>
              <td>${formatNullableNumber(item.scaleRatio)}</td>
              <td>${formatNullableCount(item.usableSampleCount)}</td>
              <td>${formatNullableNumber(item.corrCenterImageYNegTz)}</td>
              <td>${formatNullableNumber(item.corrCenterImageXNegTz)}</td>
              <td>${formatNullableNumber(item.corrCenterImageYInvNegTz)}</td>
              <td>${formatNullableNumber(item.corrCenterImageXInvNegTz)}</td>
              <td>${formatNullableNumber(item.negTzMean)}</td>
              <td>${formatNullableNumber(item.negTzRange)}</td>
              <td>${formatNullableNumber(item.negTzStdDev)}</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
...
function renderPlacementVerticalPositionSummaryHtml(
  summary: PlacementFunctionVerticalPositionSummary[],
) {
  if (summary.length === 0) {
    return `<p class="placeholder-text">解析実行後に scaleRatio + centerImageY ごとの -tz 平均を表示します。</p>`
  }
  return `
    <div class="table-scroll">
      <table class="debug-table placement-analysis-summary-table">
        ...
        <tbody>
          ${summary.map((item) => `
            <tr>
              <td>${formatNullableNumber(item.scaleRatio)}</td>
              <td>${formatNullableNumber(item.centerImageY)}</td>
              <td>${formatNullableCount(item.usableSampleCount)}</td>
              <td>${formatNullableNumber(item.negTzMean)}</td>
              <td>${formatNullableNumber(item.negTzRange)}</td>
              <td>${formatNullableNumber(item.negTzStdDev)}</td>
              <td>${formatNullableNumber(item.invNegTzMean)}</td>
              <td>${formatNullableNumber(item.invNegTzStdDev)}</td>
            </tr>
          `).join("")}
        </tbody>
      </table>
...
function renderPlacementFunctionRoundtripComparisonHtml(comparison: PlacementFunctionRoundtripComparisonState) {
  const orderByCandidateId = new Map(comparison.candidateIds.map((candidateId, index) => [candidateId, index]))
  const sortedResults = [...comparison.results].sort((a, b) => {
    const scoreCompare = comparePlacementFunctionRoundtripScore(a.scores.roundtripScore, b.scores.roundtripScore)
    if (scoreCompare !== 0) {
      return scoreCompare
    }
    return (orderByCandidateId.get(a.candidateId) ?? 0) - (orderByCandidateId.get(b.candidateId) ?? 0)
  })
  return `
    <dl class="review-grid">
      <div><dt>status</dt><dd>${comparison.status}</dd></div>
      <div><dt>sampleIndex</dt><dd>${comparison.sampleIndex ?? "-"}</dd></div>
      <div><dt>candidateIds</dt><dd>${comparison.candidateIds.map((candidateId) => escapeHtml(candidateId)).join(", ")}</dd></div>
      <div><dt>bestByRoundtripScoreCandidateId</dt><dd>${comparison.bestByRoundtripScoreCandidateId ?? "-"}</dd></div>
      <div><dt>bestByMatrixNormalizedScoreCandidateId</dt><dd>${comparison.bestByMatrixNormalizedScoreCandidateId ?? "-"}</dd></div>
      <div><dt>previewPredictedCandidateId</dt><dd>${comparison.previewPredictedCandidateId ?? "-"}</dd></div>
      <div><dt>error</dt><dd>${escapeHtml(comparison.errorMessage ?? "-")}</dd></div>
    </dl>
    ${sortedResults.length === 0 ? `<p class="placeholder-text">候補をまとめて再レンダー比較すると結果を表示します。</p>` : `
      <div class="table-scroll">
        <table class="debug-table placement-roundtrip-comparison-table">
          <thead>
            <tr>
              <th>candidateId</th>
              <th>status</th>
              <th>estimated scale</th>
              <th>estimated translate X / Y</th>
              <th>abs tx / ty / tz</th>
              <th>abs txOverNegTz / tyOverNegTz / invNegTz</th>
              <th>poseDiffMagnitude</th>
              <th>landmark mean / max</th>
              <th>matrixNormalizedScore</th>
              <th>matrixRawTranslationScore</th>
          ...
          <tbody>
            ${sortedResults.map((result) => `
              <tr>
                ...
                <td>${formatNullableNumber(result.estimatedTransform?.scaleRatio ?? null)}</td>
                <td>${formatNullableNumber(result.estimatedTransform?.translateAfterScaleImageX ?? null)} / ${formatNullableNumber(result.estimatedTransform?.translateAfterScaleImageY ?? null)}</td>
                <td>${formatNullableNumber(result.matrixError?.absTxError ?? null)} / ${formatNullableNumber(result.matrixError?.absTyError ?? null)} / ${formatNullableNumber(result.matrixError?.absTzError ?? null)}</td>
                <td>${formatNullableNumber(result.matrixError?.absTxOverNegTzError ?? null)} / ${formatNullableNumber(result.matrixError?.absTyOverNegTzError ?? null)} / ${formatNullableNumber(result.matrixError?.absInvNegTzError ?? null)}</td>
                <td>${formatNullableNumber(result.poseError?.poseDiffMagnitude ?? null)}</td>
                <td>${formatNullableNumber(result.landmarkDiffSummary?.mean2dDistance ?? null)} / ${formatNullableNumber(result.landmarkDiffSummary?.max2dDistance ?? null)}</td>
                <td>${formatNullableNumber(result.scores.matrixNormalizedScore)}</td>
                <td>${formatNullableNumber(result.scores.matrixRawTranslationScore)}</td>
                <td>${formatNullableNumber(result.scores.roundtripScore)}</td>
                <td>${escapeHtml(result.skippedReason ?? result.errorMessage ?? "-")}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>
...
function renderPlacementFunctionConditionBatchRoundtripComparisonHtml(
  ...
  return `
    <dl class="review-grid">
      ...
      <div><dt>currentCandidateId</dt><dd>${batch.currentCandidateId ?? "-"}</dd></div>
      <div><dt>elapsedMs</dt><dd>${formatNullableNumber(batch.elapsedMs)}</dd></div>
      <div><dt>estimatedRemainingMs</dt><dd>${formatNullableNumber(batch.estimatedRemainingMs)}</dd></div>
      <div><dt>bestByRoundtripScoreCandidateId</dt><dd>${batch.bestByRoundtripScoreCandidateId ?? "-"}</dd></div>
      <div><dt>bestByMatrixNormalizedScoreCandidateId</dt><dd>${batch.bestByMatrixNormalizedScoreCandidateId ?? "-"}</dd></div>
      <div><dt>Batch preview conditionKey</dt><dd>${escapeHtml(batch.previewConditionKey ?? "-")}</dd></div>
    ...
    ${sortedSummaries.length === 0 ? `<p class="placeholder-text">条件単位まとめ再レンダー比較を実行すると candidate summary を表示します。</p>` : `
      <div class="table-scroll">
        <table class="debug-table placement-condition-batch-summary-table">
          <thead>
            <tr>
              <th>candidateId</th>
          ...
          <tbody>
            ${sortedSummaries.map((summary) => `
              <tr>
                ...
                <td>${formatNullableCount(summary.winCounts.byRoundtripScore)} / ${formatNullableCount(summary.winCounts.byMatrixNormalizedScore)}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>
          ...
          <tbody>
            ${batch.worstConditions.map((condition) => `
              <tr>
                ...
                <td>${formatNullableNumber(condition.landmarkScore)}</td>
                <td>${formatNullableNumber(condition.matrixError?.absTxOverNegTzError ?? null)} / ${formatNullableNumber(condition.matrixError?.absTyOverNegTzError ?? null)} / ${formatNullableNumber(condition.matrixError?.absInvNegTzError ?? null)}</td>
                <td>${formatNullableNumber(condition.estimatedTransform?.scaleRatio ?? null)}</td>
                <td>${formatNullableNumber(condition.estimatedTransform?.translateAfterScaleImageX ?? null)} / ${formatNullableNumber(condition.estimatedTransform?.translateAfterScaleImageY ?? null)}</td>
              </tr>
            `).join("")}
          </tbody>
        </table>
...
function comparePlacementFunctionRoundtripScore(a: number | null, b: number | null) {
  const aFinite = isFiniteNumber(a)
  const bFinite = isFiniteNumber(b)
  if (aFinite && bFinite) {
    return a - b
  }
  if (aFinite) {
...
function renderPlacementFunctionRoundtripLandmarkDiffHtml(
  ...
  return `
    <dl class="review-grid">
      ...
      <div><dt>comparedTo</dt><dd>${summary.comparedTo ?? "-"}</dd></div>
    </dl>
  `
}
...
function buildPlacementFunctionAnalysisExport(): PlacementFunctionAnalysisExport {
  ...
  return {
    ...
    summary: {
      ...
      roundtripComparisonSummary: stripPlacementFunctionRoundtripComparisonState(
        state.placementAnalysis.roundtripComparison,
      ),
      conditionBatchRoundtripComparisonSummary: stripPlacementFunctionConditionBatchRoundtripComparisonState(
        state.placementAnalysis.conditionBatchRoundtripComparison,
      ),
    },
...
function stripPlacementFunctionRoundtripComparisonState(
  comparison: PlacementFunctionRoundtripComparisonState,
): PlacementFunctionRoundtripComparisonSummary {
  const {
    previewPredictedLandmarks478: _previewPredictedLandmarks478,
    previewPredictedCandidateId: _previewPredictedCandidateId,
    ...summary
  } = comparison
  return summary
}

function stripPlacementFunctionConditionBatchRoundtripComparisonState(
  comparison: PlacementFunctionConditionBatchRoundtripComparisonState,
): PlacementFunctionConditionBatchRoundtripComparisonSummary {
  const {
    previewPredictedLandmarks478: _previewPredictedLandmarks478,
    ...summary
  } = comparison
...
function buildPlacementFunctionAnalysisCsv(
  ...
  const headers = [
    ...
    "invNegTz",
    "conditionNegTzMean",
    "conditionNegTzStdDev",
    "conditionNegTzRange",
    "conditionInvNegTzMean",
    "conditionInvNegTzStdDev",
    "conditionInvNegTzRange",
    "scalePositionCorrCenterYNegTz",
    "scalePositionCorrCenterXNegTz",
    "txOverNegTz",
    "tyOverNegTz",
    "matrixUniformScale",
  ...
  const conditionStatsByKey = buildPlacementFunctionConditionStats(samples)
  const positionCorrelationByScale = new Map(
    buildPlacementFunctionPositionCorrelationSummary(samples).map((summary) => [
      formatPlacementScaleKey(summary.scaleRatio),
      summary,
    ]),
  )
  ...
  const rows = samples.map((sample) => {
    ...
    return [
      ...
      sample.matrixFeatures.invNegTz ?? "",
      conditionStats?.negTzMean ?? "",
      conditionStats?.negTzStdDev ?? "",
      conditionStats?.negTzRange ?? "",
      conditionStats?.invNegTzMean ?? "",
      conditionStats?.invNegTzStdDev ?? "",
      conditionStats?.invNegTzRange ?? "",
      positionCorrelation?.corrCenterImageYNegTz ?? "",
      positionCorrelation?.corrCenterImageXNegTz ?? "",
      sample.matrixFeatures.txOverNegTz ?? "",
      sample.matrixFeatures.tyOverNegTz ?? "",
