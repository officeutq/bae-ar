...
export function buildBackgroundGridDebugJson(
  ...
  return {
    ...
    summary: roundDebugValue({
      ...
      sweptPathExclusionEnabled: debug.sweptPathExclusionEnabled,
      sweptPathExclusionRadiusPx: debug.sweptPathExclusionRadiusPx,
      excludedSweptPathPointCount: debug.excludedSweptPathPointCount,
      sweptPathSegmentCount: debug.sweptPathSegmentCount,
      sweptPathExclusionSkippedReason: debug.sweptPathExclusionSkippedReason,
