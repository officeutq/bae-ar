...
この tool では現時点で mesh pair の overlay / summary / preview raw debug までを扱います。triangle indices 作成、triangle mesh 作成、WebGL warp、raw displacement mesh warp、Runtime / Engine 変更、Beauty Studio 変更、IdealFace Authoring Tool 変更、JSON export / import、保存機能は含めません。
