...
現在 `tools/ideal-face-authoring` は Step 2-I-A まで実装済みです。`tools/layer-mask-authoring` は将来予定です。
...
- IdealFace Authoring Tool は Step 2-I-A まで実装済み
